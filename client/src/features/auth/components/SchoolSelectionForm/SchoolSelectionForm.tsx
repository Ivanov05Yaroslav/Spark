...
import styles from "@/features/auth/components/SchoolSelectionForm/SchoolSelectionForm.module.css";
import { schoolService } from '@/api/school.service.ts';
import { SelectOption } from '@/components/ui/Select/Select.tsx';
