    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px', height: '100%' }}>
            ...
            <div style={{fontSize: '13px', fontFamily: 'Inter, sans-serif', color: '#7E7E7E'}}>
                Завантажити CSV шаблон <span style={linkStyle} onClick={downloadTemplate}>тут</span>
                <br/>
                Завантажити інструкцію <span style={linkStyle} onClick={downloadInstructions}>тут</span>
            </div>
