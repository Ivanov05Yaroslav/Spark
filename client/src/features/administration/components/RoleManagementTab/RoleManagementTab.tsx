    ...
    <div className={styles.container}>
      ...
      <div className={styles.list}>
        {users.length > 0
          ...
          : !isLoading && <div className={styles.statusMessage}>Користувачів не знайдено</div>}

        <div ref={sentinelRef} style={{ height: '10px' }} />

        {isLoading && (
          <div className={styles.statusMessage}>Завантаження нових користувачів...</div>
        )}
      </div>
      ...
      <ConfirmDeleteModal
        ...
        itemName={
          deleteModal.userName ? `користувача ${deleteModal.userName}` : 'цього користувача'
        }
      />
    </div>
  );
