...
export const useEditTaskForm = () => {
    ...
    const handleRemoveFile = (indexToRemove: number) => setUploadedFiles(prev => prev.filter((_, index) => index !== indexToRemove));
    ...
    const handleRemoveLink = (indexToRemove: number) => setUploadedLinks(prev => prev.filter((_, index) => index !== indexToRemove));
    ...
    return {
        formState: {
            ...
            dueDate, setDueDate,
            module, setModule,
            nusGroup, setNusGroup,
            hideTask, setHideTask
        },
        filesState: {
            uploadedFiles, setUploadedFiles,
            isUploadModalOpen, setIsUploadModalOpen,
            handleFilesSelectFromModal, handleRemoveFile
        },
        linksState: {
            uploadedLinks, setUploadedLinks,
            isUploadLinkModalOpen, setIsUploadLinkModalOpen,
            linkInput, setLinkInput,
            linkNameInput, setLinkNameInput,
