...
export const TestOverviewCard: React.FC<Props> = ({
                                                      duration, attemptsAllowed, questionsCount, dueDate, onStart
                                                  }) => {
    return (
        <ContentCard title="Деталі тесту">
            <div className={styles.container}>
                <div className={styles.infoList}>
                    ...
                    <InfoItem icon={CalendarIcon} title="Термін виконання" subtitle={dueDate} className={styles.purpleIconItem}/>
                </div>
