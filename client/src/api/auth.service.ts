import {
    ...
    ResendCodeResponse,
    CitiesResponseDto,
    InitSchoolRegistrationRequest, InitSchoolRegistrationResponse,
    RegionsResponseDto, SchoolDetailsRequest, SchoolDetailsResponse,
    SchoolsResponseDto, SubmitSchoolDocsRequestDTO, SubmitSchoolDocsResponseDTO,
