...
export const administrationService = {
    ...
    getUsers: (params: { search?: string; page?: number; limit?: number }) =>
        apiClient.get<GetUsersResponse>('/users/admin/school-users', { params }).then(res => res.data),
    ...
    bulkRegisterUsers: (file: File) => {
        ...
        return apiClient.post('/users/admin/bulk', formData, {
            headers: {
    ...
    downloadBulkTemplate: () =>
        apiClient.get('/users/admin/bulk/template').then(res => res.data),
